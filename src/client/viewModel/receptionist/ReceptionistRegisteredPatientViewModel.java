...
/**
 * View model for the Receptionist Registered Patient screen.
...
public class ReceptionistRegisteredPatientViewModel {
    ...
    /**
     * Creates a new {@code ReceptionistRegisteredPatientViewModel} initialised with the given client, patient view model.
     *
